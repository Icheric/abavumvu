                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_p_current_price[$i]; ?> RWF</td>
                        ...
                        <tr>
                            ...
                            <th class="total-amount"><?php echo $table_total_price; ?> RWF</th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo $shipping_cost; ?> RWF</td>
                        </tr>
                        <tr>
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group" >
                                            <label style="display:none" for=""><?php echo LANG_VALUE_43; ?></span></label><br>
                                            <?php
                                            $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        ...
                                        <div class="col-md-12 form-group" style="display:none">
                                            <label for=""><?php echo LANG_VALUE_44; ?> <br><span style="font-size:12px;font-weight:normal;display:none">(<?php echo LANG_VALUE_45; ?>)</span></label>
                                            <textarea name="transaction_info" class="form-control" cols="30" rows="10" style="display:none">.......</textarea>
                                        </div>
                                        <div class="col-md-12 form-group">
