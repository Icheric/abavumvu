					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del><?php echo $p_old_price; ?> RWF</del>
                                    <?php endif; ?> 
                                        <?php echo $p_current_price; ?> RWF
                                </span>
                            </div>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="color:#e0b23a"><?php echo LANG_VALUE_155; ?></h2>
                    <!-- <h3><?php //echo LANG_VALUE_156; ?></h3> -->
                    <h3 style="color:white">Roots Collection</h3>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3 ><a href="product.php?id=<?php echo $row['p_id']; ?>" style="color:#fff"><?php echo $row['p_name']; ?></a></h3>
                                <h4 style="color:#e0b23a">
