                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a  style="color:white" href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?></a></h3>
                                <h4>
...
<div class="product bg-gray pt_70 pb_30">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="color:#fdcb0d"><?php echo $latest_product_title; ?></h2>
                    <h3 style="color:#fdcb0d"><?php echo $latest_product_subtitle; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a href="product.php?id=<?php echo $row['p_id']; ?>" style="color:white"><?php echo $row['p_name']; ?></a></h3>
                                <h4 style="color:#fdcb0c">
                                    <?php echo number_format($row['p_current_price']); ?> RWF
                                    <?php if($row['p_old_price'] != ''): ?> RWF
                                    <del>
