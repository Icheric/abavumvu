...
if(ISSET($_POST['save'])){
    ...
    if ($file_name != "") {
        ...
        $sql = "UPDATE team SET fullname='$fullname', position='$position',fb='$fb', ig='$ig',tw='$tw',image='$new_file_name' WHERE id=$teamid";
    } else {
        // No new file has been uploaded, only update the title and text fields
        $sql = "UPDATE team SET fullname='$fullname', position='$position',fb='$fb', ig='$ig',tw='$tw' WHERE id=$teamid";
    }
...
<div class='alert alert-success alert-dismissible alert-outline fade show'>
 ...
 "; //printing error if found in validation
  echo "<meta http-equiv='refresh' content='2;url=team'>";
                                              ...
                                              <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="ig" value="<?php print $ig ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Facebook</label>
                                                            <input type="text" class="form-control"  name="fb" value="<?php print $fb ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Twitter</label>
                                                            <input type="text" class="form-control"  name="tw" value="<?php print $tw ?>">
                                                        </div>
                                                    </div>
