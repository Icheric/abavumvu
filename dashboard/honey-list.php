                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Benefits List</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        <thead>
                                            <tr>
                                            <th data-ordering="false">Benefit</th>
                                            <th data-ordering="false">percentege</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <?php
				   $q="SELECT * FROM  benefit ORDER BY id DESC";
